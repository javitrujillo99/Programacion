...
public class Ejercicio5Cap2 {

	public static void main(String[] args) {
		/*Pedir al usuario cinco números, e imprimir posteriormente el 
		 mayor valor introducido y el menor valor introducido.*/
		...
		if (var1 <= var2 && var1 <= var3 && var1 <= var4 && var1 <= var5) {
			...
			System.out.println("El número menor es el " + var4);
		}
		else if (var5 <= var1 && var5 <= var3 && var5 <= var4 && var5 <= var2) {
			System.out.println("El número menor es el " + var5);
		}
		}
	}
